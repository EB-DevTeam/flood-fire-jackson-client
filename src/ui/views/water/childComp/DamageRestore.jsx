...
export default function DamageRestore() {
  return (
    <section className="damageRestore__section">
      <div className="imageLeftFlush__div-gridBox damageRestore_gridBox">
        ...
        <div className="imageLeftFlush__div-boxTwo">
          ...
          We guarantee the quickest response time and also offer free water damage assessments so that you can get a full understanding of the situation and what needs to be done to fix the problem.          </p>
