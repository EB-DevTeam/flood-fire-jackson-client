...
export default function CraftsMatter() {
  return (
    <section>
      <div className="imageRight__div-cont">
        <div className="imageRight__div-textCont">
          <h2 className="imageRight__h2">Craftsmanship Matters</h2>
        ...
        <div className="imageRight__img craftsMatter__img"></div>
      </div>
    </section>
  );
}
